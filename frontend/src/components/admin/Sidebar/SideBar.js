        ...
        <aside className="sticky top-0 h-screen">
            <div className={`${open ? 'w-72' : 'w-24'} duration-300 h-screen p-6 pt-10 bg-dark-purple`}>
                ...
                <div className="flex gap-x-4 items-center">
                    <img src="/assets/Student.png" alt="" className={`cursor-pointer duration-500 w-20`} />
                    <h1 className={`text-white origin-left font-medium text-xl duration-300
                ${!open && "scale-0"}`}>Welcome, Admin</h1>
                </div>
                <ul className="pt-20">
                    ...
                    (
                        ...
                        ${menu.gap ? "mt-9" : "mt-2"} ${index === active && 'bg-light-white'}`}>
                                <img src={`/assets/${menu.src}.png`} alt="" className="w-8 bg-white p-1 rounded-md" />
